...
0 16 14 Joystick button2 3 45 Joystick button (in towards battery on
base board)
...
{
Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, GPIO_INTERRUPT_PORT, (1 <<
GPIO_INTERRUPT_PIN_A)|(1 << GPIO_INTERRUPT_PIN_B));
...
Chip_GPIOINT_SetIntFalling(LPC_GPIOINT, GPIO_INTERRUPT_PORT, (1 << GPIO_INTERRUPT_PIN_A)|(1
